...
class DGRec(torch.nn.Module):
    def __init__(
        ...
        self.aggregator_type = hyper_param['aggregator_type']
    ...
    def forward(self, feed_dict, labels):
        ...
        friend_emb_seqs1 = friend_emb_seqs1.view(self.batch_size * self.samples_1 * self.samples_2, self.max_length, self.embedding_size)
